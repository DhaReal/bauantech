...
<?php if($_SESSION['login']!="")
{
 ...
 ?>
    ...
    color: #ab0606;
    font-size: 20px;
    margin-bottom: 40px;">My Profile</h1>
                    </div>
                </div>
                <div class="row" >
...
<div class="form-group">
    <label for="CGPA">Strand
      </label>
    <input type="text" class="form-control" id="cgpa" name="cgpa"  readonly value="<?php echo htmlentities($row['department']);?>" required />
  </div>  

<div class="form-group">
    <label for="CGPA">Semester
      </label>
    <input type="text" class="form-control" id="cgpa" name="cgpa"  readonly value="<?php echo htmlentities($row['semester']);?>" required />
  </div>  
