...
$ret=mysqli_query($bd, "insert into students(studentName,StudentRegno,Semester,department,password,pincode) values('$studentname','$studentregno','$semester','$strand','$password','$pincode')");
if($ret)
{
...
<?php if($_SESSION['alogin']!="")
{
 ...
 ?>
    ...
    color: #ab0606;
    font-size: 20px;
    margin-bottom: 40px;">Student Registration</h1>
                    </div>
                </div>
                <div class="row" >
