...
$ret=mysqli_query($bd, "insert into course(courseName) values('$coursename')");
if($ret)
{
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    <label for="coursename">Add Strand  </label>
    <input type="text" class="form-control" id="coursename" name="coursename" placeholder="Strand" required />
  </div>
