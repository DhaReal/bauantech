...
if($ret)
{
$_SESSION['msg']="Grade Level Added Successfully !!";
}
else
{
  $_SESSION['msg']="Error : Grade Level not added";
}
}
if(isset($_GET['del']))
      {
              mysqli_query($bd, "delete from session where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Year Level deleted !!";
      }
?>
...
<?php if($_SESSION['alogin']!="")
{
 ...
 ?>
    ...
    color: #ab0606;
    font-size: 20px;
    margin-bottom: 40px;">Add Grade Level  </h1>
                    </div>
                </div>
                <div class="row" >
